        ...
        <div>
            ...
            <main className="bg-neutro pt-16 text-slate-50 text-lg md:text-2xl font-poppins ">
                <article className="max-w-screen-xl mx-auto space-y-8 px-8 mb-24 2xl:px-0">
                    ...
                    <div className="">
                        <img src="https://ik.imagekit.io/rld8rfell/atlas-galery/trainner-thumb.jpg?updatedAt=1685401219099" alt="" className="md:w-1/3 md:float-right clear-left md:ml-8" />
                    </div>

                    <p>Nuestro gimnasio ofrece una <Link to="/mockup-atlas-gym/actividades" className="text-color-2 underline font-bold hover:text-color-3">amplia variedad de actividades</Link> para mantenerte motivado y comprometido. Desde entrenamientos de alta intensidad hasta yoga y entrenamiento de fuerza, hay algo para todos. </p>
                    ...
                    <div className="">
                        <img src="https://ik.imagekit.io/rld8rfell/atlas-galery/room_maquinas-thumb.jpg?updatedAt=1685401204184" alt="" className=" md:w-1/3 md:float-left clear-right md:mr-8 " />
                    </div>
                    ...
                    <p>Visítenos en nuestra sede o <Link to="/mockup-atlas-gym/contacto" className="text-color-2 underline font-bold hover:text-color-3">contáctenos</Link> para comenzar su viaje de acondicionamiento físico. Juntos, logremos una salud y bienestar óptimos en <span className="text-color-2 font-bold">Atlas</span>.</p>
                </article>
