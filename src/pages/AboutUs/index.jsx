        ...
        <div>
            ...
            <main className="bg-neutro pt-16 text-slate-50 text-lg md:text-2xl font-poppins ">
                <article className="max-w-screen-xl mx-auto space-y-8 px-8 mb-24 2xl:px-0">
                    ...
                    <div className="">
                        <img src="mockup-atlas-gym/src/assets/images/galery/trainner-thumb.jpg" alt="" className="md:w-1/3 md:float-right clear-left md:ml-8" />
                    </div>
                    ...
                    <div className="">
                        <img src="mockup-atlas-gym/src/assets/images/galery/room_maquinas-thumb.jpg" alt="" className=" md:w-1/3 md:float-left clear-right md:mr-8 " />
                    </div>
